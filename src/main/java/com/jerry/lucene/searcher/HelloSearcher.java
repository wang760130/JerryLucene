...
public class HelloSearcher {
	...
	public void searcherByHighlighter(String query) {
		try {
			...
			for(ScoreDoc sd : tds.scoreDocs) {
				...
				title = lighterStr(analyzer, q, title, "title");
	...
	private String lighterStr(Analyzer a, Query query, String txt, String fieldname) throws IOException, InvalidTokenOffsetsException {
		...
		String str = lighter.getBestFragments(a.tokenStream(fieldname,new StringReader(txt)),txt, 3, "......\n");
		if(str == null)
			return txt;
		return str;
	}
